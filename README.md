...
# RESTful microservice API development using Python Flask without Flask-restful

# Technicalities
RESTful API development with pure Python Flask
...
In the browser navaigate to [getEmpById](http://localhost:8090/emp/13)
